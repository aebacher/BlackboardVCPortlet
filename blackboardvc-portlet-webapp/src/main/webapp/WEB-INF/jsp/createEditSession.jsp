...
<c:if test="${!empty prefs['helpUrl'][0]}">
	<div class="help-link">
	  <a href="${prefs['helpUrl'][0]}" target="_blank" class="btn btn-flat uportal-button"><spring:message code="help" text="help"/></a>
	</div>
</c:if>
  ...
  <div class="bb-content-container">
	<h3><spring:message code="enterInfo" text="enterInfo"/></h3>
		...
		<div class="form-group row">
		    <label for="sessionName" class="col-md-3"><spring:message code="sessionName" text="sessionName"/></label>
		    <div class="col-md-9">
			    <c:choose>
		...
		<div class="form-group row">
		    <label for="endDateAndTime" class="col-md-3"><spring:message code="endDateAndTime" text="endDateAndTime"/></label>
		   <div class="col-md-9">
			   <span class="datepair">
